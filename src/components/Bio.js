    ...
    return (
      <div className="bio-container">
        ...
        <p className="about-section">
          Dan Lubbers is a Full Stack Web Developer with an extensive background
          in Photography & Retouching. Lubbers got his start with Extreme Sports
          Photography when he was the sole photographer on the La Sportiva
          Solutions Climbing Tour in 2007 and began shooting for Extreme Sports
          Editorials and various outdoor companies. Lubbers went on to work in{" "}
          <a
          ...
          photographing and retouching for the Jewelry and Watch department. He
          ...
          . Wanting to add more to his career and an interest in Design and
          Coding led him to Utah, to take a 3 month intensive Web Development
          Bootcamp at{" "}
          <a
            className="devMtn"
